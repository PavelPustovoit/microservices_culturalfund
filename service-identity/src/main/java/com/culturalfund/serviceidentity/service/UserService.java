...
public class UserService {
    ...
    public long create(String name, String surname, String email, String password, UserType userType) {

        final User user = new User(name, surname, email, password, userType);
